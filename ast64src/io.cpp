...
std::shared_ptr<spdlog::logger> io_logger = Logger::createLogger("io_logger");
void dd(std::string &&flg,std::string &&msg){
  io_logger->info("{}:{}",flg,msg);
}
...
int NInputRange(CONST char *szPrompt, int low, int high, int pm)
{
  ...
  dd("NInputRange 555 line ",szPrompt);
