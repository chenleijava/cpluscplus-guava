   ...
   public:
    ExperimentalWithCallbackMethod_GetFeature() {
      ::grpc::Service::experimental().MarkMethodCallback(0,
        new ::grpc::internal::CallbackUnaryHandler< ExperimentalWithCallbackMethod_GetFeature<BaseClass>, ::routeguide::Point, ::routeguide::Feature>(
   ...
   public:
    ExperimentalWithRawCallbackMethod_GetFeature() {
      ::grpc::Service::experimental().MarkMethodRawCallback(0,
        new ::grpc::internal::CallbackUnaryHandler< ExperimentalWithRawCallbackMethod_GetFeature<BaseClass>, ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
          [this](::grpc::ServerContext* context,
