...
#ifndef PROTOBUF_INCLUDED_auth_5fsample_2eproto
#define PROTOBUF_INCLUDED_auth_5fsample_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_auth_5fsample_2eproto 
...
namespace google {
namespace protobuf {
template<> ::grpc::testing::Request* Arena::CreateMaybeMessage<::grpc::testing::Request>(Arena*);
template<> ::grpc::testing::Response* Arena::CreateMaybeMessage<::grpc::testing::Response>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace grpc {
namespace testing {
...
#endif  // PROTOBUF_INCLUDED_auth_5fsample_2eproto
